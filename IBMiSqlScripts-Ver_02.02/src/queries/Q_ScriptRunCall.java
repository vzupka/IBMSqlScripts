...
//    Vector<String> messages = new Vector<>();
    ...
    public void buildScriptList() {
        ...
        scriptListImportButton.addActionListener(a -> {
            ...
            if (rowIndexList != null) { // row index not empty
                ...
                // to import
                    ...
                    Q_PromptImportScript promptImportScript = new Q_PromptImportScript();
                    promptImportScript.showPrompt();
                }
        ...
        scriptListRunButton.addActionListener(a -> {
            retCode = runScript(Q_ConnectDB.connection);
            scriptListMsg.setText(retCode[1]);
            scriptListMsgPanel.add(scriptListMsg);
        });
        ...
        // ------------------------------------------
        scriptListGlobalPanel.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke("ENTER"), "filterScripts");
        scriptListGlobalPanel.getActionMap().put("filterScripts", new FilterScripts());
        ...
        this.setSize(scriptListGlobalWidth, scriptListGlobalHeight);
    ...
    /**
     * Reads script files from directory "scriptfiles" and puts data to tree map "scriptNames"
    ...
    /**
     * Method "runScript()" performs the selected script - called from "Run" button Q_MenuUser.
     * 
     * @param connection
     * @return retCode
     */

    protected String[] runScript(Connection connection) {
        System.out.println("method runScript was called from 'Run selected' button in Q_MenuUser.");
        scriptListMsg.setForeground(DIM_BLUE); // Dim blue
        scriptListMsgPanel.removeAll();
    ...
    /**
     * Inner class for filter input script files
     */
    class FilterScripts extends AbstractAction {
    ...
    class ScriptTableMouseAdapter extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent mouseEvent) {
            ...
            if (mouseEvent.getClickCount() == 2) {
                runScript(Q_ConnectDB.connection);
            }
        }
    }
}
