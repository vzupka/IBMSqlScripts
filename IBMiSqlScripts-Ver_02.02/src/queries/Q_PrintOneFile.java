...
public class Q_PrintOneFile extends JDialog {
    ...
    protected Q_PrintOneFile(String scriptName, JTextArea resultTextArea, int nbrHdrLines,
        ...
        windowHeight = Integer.parseInt(prop.getProperty("RESULT_WINDOW_HEIGHT"));
        windowWidth = Integer.parseInt(prop.getProperty("RESULT_WINDOW_WIDTH"));
        ...
        if (!printArrayList.isEmpty()) {
            ...
            try {
                ...
                fontSize = Integer.parseInt(fontSizeScript);
            ...
            try {
                ...
                leftMargin = Integer.parseInt(leftMarginStr);
            } catch (NumberFormatException e) {
                leftMargin = 10;
            }
            ...
            try {
                ...
                rightMargin = Integer.parseInt(rightMarginStr);
            } catch (NumberFormatException e) {
                rightMargin = 10;
            }
            ...
            try {
                ...
                topMargin = Integer.parseInt(topMarginStr);
            } catch (NumberFormatException e) {
                topMargin = 10;
            }
            ...
            try {
                ...
                bottomMargin = Integer.parseInt(bottomMarginStr);
            } catch (NumberFormatException e) {
                bottomMargin = 10;
            }
