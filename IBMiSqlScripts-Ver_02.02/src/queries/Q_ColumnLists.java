 ...
 * @author vzupka
 */
public class Q_ColumnLists extends JDialog {
    ...
    protected String[] createWindow() {
        ...
        try {
            dbMetaData = Q_ConnectDB.connection.getMetaData();
        ...
        horizontal.addItemListener(il -> {
            ...
            if (source == horizontal) {
                horizontalSet = horizontal.isSelected();
            }
        });
        ...
        appended.addItemListener(il -> {
            Object source = il.getSource();
            if (source == appended) {
                appendedSet = appended.isSelected();
            }
        });
