...
public class L_MessageBundle_en_US extends ListResourceBundle {
   ...
   private final Object[][] contents = { 
         // Q_ParametersEdit
         { "ParSaved", "Parameters have been saved." },
         // Q_Menu
         ...
         // Q_ConnectAS400
         { "ConnLost", "Connection lost from the host " },
        ...
        // Q_ScriptEditCall
         ...
         { "File", "File  " },
         { "Exists", " already exists in directory \"scriptfiles.\" " },
         ...
         { "StmtSuccess", "Statement was executed." },
         { "ScriptSuccess", "Script was successful." },
         ...
         // Q_PromptAddScript
         { "IsEmpty", "Name must not be empty and must end with .sql." },         
