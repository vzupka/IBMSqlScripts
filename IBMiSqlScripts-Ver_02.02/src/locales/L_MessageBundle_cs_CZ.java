...
public class L_MessageBundle_cs_CZ extends ListResourceBundle {
   ...
   private final Object[][] contents = {
         ...
         { "File", "Soubor  " },
         { "Exists", " už existuje v adresáři \"scriptfiles.\" " },
         ...
         { "ScriptSuccess", "Skript byl úspěšný." },
         ...
         // Q_PromptAddScript
         { "IsEmpty", "Jméno nesmí být prázdné a musí končit .sql." },         
